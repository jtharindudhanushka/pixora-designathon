...
export function createTelemetryRouter(anomalyDetector, lockTelemetry, executeAction, broadcastWs) {
    const router = Router();
    /**
     ...
     */
    router.post('/inject-anomaly', (req, res) => {
     ...
     */
    router.post('/assistant/command', (req, res) => {

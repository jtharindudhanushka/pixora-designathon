...
export class HardwareDaemon {
    ...
    constructor() {
        this.turnstile = new TurnstileRelayEmulator(CONFIG.TOWER_ID, '1', (topic, msg) => this.publish(topic, msg));
        this.elevator = new ElevatorControllerEmulator(CONFIG.TOWER_ID, 'bank-a', 'CABIN-A1', (topic, msg) => this.publish(topic, msg));
        this.lockTelemetry = new LockTelemetryEmitter(CONFIG.TOWER_ID, CONFIG.DEFAULT_UNIT, 'LOCK-1402-YALE', (topic, msg) => this.publish(topic, msg));
    }
    connect() {
    ...
    handleUnitDeviceCommand(topic, command) {
    ...
    broadcastUnitDeviceState(deviceId, state) {

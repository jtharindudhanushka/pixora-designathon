...
export interface TokenPayload {
  ...
  tower: string;
  unit: string;
  jti: string; // Unique Token Identifier for single-use invalidation
  scopes: string[];
  expiresAt: number;
  metadata?: {
    partner?: string;
...
export function issueToken(
  ...
  ttlMinutes = CONFIG.PASS_TTL_MINUTES,
 ...
 */
export function consumeSingleUseToken(jti: string): boolean {
 ...
 */
export function hasScope(role: UserRole, requiredScope: string): boolean {
